  ...
  return {
    ...
    objects: {
      vieille_enseigne: {
        ...
        description:
          "Une enseigne en bois sculpté représentant un loup hurlant, suspendue au-dessus de l'entrée de la taverne. La peinture s'écaille par endroits.",
        locationId: "place_centrale",
        ownerId: null,
        properties: {},
      },
      pain_taverne: {
        ...
        name: "miche de pain",
        description:
          "Un pain rond à la croûte épaisse, encore tiède. L'odeur est irrésistible.",
        locationId: null,
        ownerId: "tariq",
      ...
      lanterne_taverne: {
        ...
        description:
          "Une lanterne en fer forgé qui diffuse une lumière chaude et vacillante.",
        locationId: "taverne_du_loup",
        ownerId: null,
        properties: { lit: true },
      },
      marteau_hamid: {
        ...
        description:
          "Un lourd marteau en acier, le manche poli par des années d'usage. Clairement l'outil d'un maître.",
        locationId: "forge_hamid",
        ownerId: null,
      ...
      minerai_fer: {
        ...
        name: "minerai de fer",
        description:
          "Un bloc de minerai brut, aux reflets gris-brun. Hamid le travaillera bientôt.",
        locationId: "forge_hamid",
        ownerId: null,
        properties: { heavy: true },
      },
      lanterne_rouille: {
        ...
        description:
          "Une vieille lanterne dont la rouille a mangé les bords. Elle brûle encore, faiblement.",
        locationId: "ferme_oumou",
        ownerId: null,
        properties: { lit: true },
      },
      panier_legumes: {
        ...
        description:
          "Un grand panier en osier rempli de carottes, de navets et d'herbes aromatiques fraîches.",
        locationId: null,
        ownerId: "oumou",
        properties: { edible: true },
      },
